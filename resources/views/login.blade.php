...
<body>
	...
	<!-- Header-->
	<div id="header" name="Iniciar sesión", subtitle='Variedad y calidad'></div>
	<form action="http://localhost:8000/login" method="get">
		<div style="margin-left: 600px; margin-right: 650px; margin-top: 50px" align="center">
			<div name="inputItemX" id="user" desc="Usuario" type="text"></div>
			<div name="inputItemX" id="pass" desc="Contraseña" type="text"></div>
			<div class="col-auto">
